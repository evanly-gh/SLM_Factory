...
**Companion to:** [07-28b-benchmark-research.md](07-28b-benchmark-research.md)
...
> eight. See [08-12-new-tasks-loaders.md](08-12-new-tasks-loaders.md).
...
already shows Q4 costs 0.0300 on reasoning vs. 0.0008 on NER — [followups §1.4](07-28-followup-fixes.md)).
...
- pos/neg/boundary per [followups §1.1](07-28-followup-fixes.md) conventions:
...
- Set `stop_threshold` from a **real leaderboard**, not planner recall (the NER run's failure came
  from an ungrounded 0.88 — [2026-07-26 §1.2](07-26-ner-math-review.md)).
