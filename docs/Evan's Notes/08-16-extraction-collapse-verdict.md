...
Companions: `08-15-contamination-qc-audit.md` (the audit),
`08-15b-label-space-lockdown.md` (the lockdown), and
`08-06-benchmark-tasks-reference.md` (task reference, now superseded on the task list).
