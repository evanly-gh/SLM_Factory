...
Companion docs: `07-31-benchmark-selection.md` (why these six were chosen) and
...
> is still correct. See `08-12-new-tasks-loaders.md`.
...
>
> Full detail: `08-16-extraction-collapse-verdict.md`.
...
> `08-15-contamination-qc-audit.md` §4. Three corrections to this
> note's framing:
>
