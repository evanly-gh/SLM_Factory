...
Companions: `2026-08-14-routerbench-postmortem-crashes-and-the-ner-teacher-baseline.md` (the
immediately preceding post-mortem, which this extends), `2026-08-13-overnight-four-task-run-log.md`
(the campaign log), `2026-08-06-six-benchmark-tasks-reference.md` (task reference).

> **Follow-up 2026-08-15b** — `2026-08-15b-label-space-lockdown-synthesis-quality-and-open-decisions.md`
...
`2026-08-11-throughput-and-sizing-fixes.md` and untouched by this work.
