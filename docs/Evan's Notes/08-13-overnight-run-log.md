...
Companion: `08-12-new-tasks-loaders.md` (the pre-flight audit this campaign
acts on) and `08-06-benchmark-tasks-reference.md` (scoring and prompts).
...
`08-12-new-tasks-loaders.md` §5 was true but was not the whole story, and
...
> `08-14-routerbench-postmortem.md` §1.
