...
Companion: `08-13-overnight-run-log.md` (the campaign log) and
`08-12-new-tasks-loaders.md` (the pre-flight audit).

> **Follow-up 2026-08-15** — `08-15-contamination-qc-audit.md`
