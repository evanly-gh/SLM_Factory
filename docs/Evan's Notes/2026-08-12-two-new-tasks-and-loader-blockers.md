...
Companion docs: `2026-08-06-six-benchmark-tasks-reference.md` (the six as of Aug 6 — still
accurate on scoring and prompts, now incomplete on the task list),
`2026-07-31-six-task-benchmark-selection.md` (why those six), and
`2026-08-11-throughput-and-sizing-fixes.md` (the most recent implementation state).
...
(`2026-08-10-dialogsum-run-postmortem-and-open-issues.md` §1) and it is still the open policy
...
`2026-08-06-six-benchmark-tasks-reference.md` §1 explicitly excludes it. It runs through the
...
- `2026-08-06-six-benchmark-tasks-reference.md` — the registry is unchanged in code, but the
  claim that all six "pull live from HuggingFace at load time" is now only true for four of them.
  Update banner added.
- `2026-07-31-six-task-benchmark-selection.md` — the selection rationale stands; the availability
